...
namespace BlazorApp.Helpers
{
    public class FakeBackendHandler : HttpClientHandler
    {
        ...
        {
            var users = new[] { new { Id = 1, Username = "test", Password = "test", FirstName = "Ramesh", LastName = "Balyam" } };
            ...
            async Task<HttpResponseMessage> authenticate()
            {
                ...
                return await ok(new {
                    ...
                    Token = "91380260512e497aa631d9b9a348f65f"
                });
            }
            ...
            bool isLoggedIn()
            {
                return request.Headers.Authorization?.Parameter == "91380260512e497aa631d9b9a348f65f";
            } 
        }
    }
}